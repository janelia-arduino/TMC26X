...
void loop()
{
  // step_dir_controller.setMode(MOTOR,TMC26X::VELOCITY_MODE);
  step_dir_controller.setMode(MOTOR,TMC26X::RAMP_MODE);

  TMC26X::Mode mode = step_dir_controller.getMode(MOTOR);
  ...
  TMC26X::Status status = step_dir_controller.getStatus();
  ...
  TMC26X::ReferenceConfiguration ref_conf = step_dir_controller.getReferenceConfiguration(MOTOR);
  ...
  TMC26X::InterfaceConfiguration if_conf = step_dir_controller.getInterfaceConfiguration();
  ...
  TMC26X::SwitchState switch_state = step_dir_controller.getSwitchState();
  ...
  TMC26X::ClockConfiguration clk_config = step_dir_controller.getClockConfiguration(MOTOR);
